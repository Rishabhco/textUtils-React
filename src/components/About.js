        ...
        <div className="container" style={Styles}>
            ...
            <div className="accordion" id="accordionExample">
                <div className="accordion-item">
                    ...
                    <div id="collapseOne" className="accordion-collapse collapse show" style={Styles} aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                ...
                <div className="accordion-item">
                    ...
                    <div id="collapseTwo" className="accordion-collapse collapse" style={Styles} aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                        <div className="accordion-body">
                ...
                <div className="accordion-item">
                    ...
                    <div id="collapseThree" className="accordion-collapse collapse" style={Styles} aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                        <div className="accordion-body">
